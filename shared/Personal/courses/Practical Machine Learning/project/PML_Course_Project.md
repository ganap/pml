# Predicting the exercise manner of individuals
Gana Pemmanda  
Thursday, Aug 21, 2014  

## Abstract
I use the random forest method to estimate features for the exercise data set provided in this course project. I then validate whether  this method produces relevant results.
...
First, I loaded the data both from the provided training and test data provided by the course.
...
set that only included complete columns.  
...
## Balanced Accuracy       0.999    0.996    0.994    0.994    0.998
```
